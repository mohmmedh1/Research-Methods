...
| **7** | Inferential Statistics & Hypothesis Testing | [U7.md](unit07/U7.md) / [Worksheet PDF](unit07/Unit7_Inferential_Statistics_and_Hypothesis_Testing.pdf) | Applied inferential statistics to real datasets, exploring probability, t-tests, and chi-square analysis to strengthen data interpretation in research. |
| **8** | Data Analysis and Visualisation | [U8.md](unit08/U8.md) / [Worksheet PDF](unit08/Unit8_Data_Analysis_and_Visualisation.pdf) | Compared qualitative and quantitative data analysis techniques and created visual representations using descriptive statistics and charting methods. |
| **9** | Validity and Generalisability in Research | [U9.md](unit09/U9.md) / [Worksheet PDF](unit09/Unit9_Validity_and_Generalisability.pdf) | Evaluated research validity, reliability, and generalisability through inferential testing and Power BI visualisation, linking ethical analytics to cybersecurity contexts. |
...
| **Reflection** | End-of-Module Reflection & e-Portfolio Narrative | [Reflection_Research Method.pdf](Reflection/Reflection_Research%20Method.pdf) / [Reflective_Piece_RMPP.md](Reflection/Reflective_Piece_RMPP.md) / [e-Portfolio.pdf](Reflection/e-Portfolio.pdf) | Consolidated academic and professional growth across the *Research Methods and Professional Practice (RMPP_PCOM7E)* module using Rolfe’s (2001) reflective model. Demonstrated integration of ethics, methodological rigour, quantitative analysis, and personal action planning — showcasing the transformation from a technical practitioner to a reflective cybersecurity researcher. |
